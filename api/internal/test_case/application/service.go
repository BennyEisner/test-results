...
func (s *TestCaseService) GetTestCase(ctx context.Context, id int64) (*models.TestCase, error) {
	if id <= 0 {
...
func (s *TestCaseService) GetTestCasesBySuite(ctx context.Context, suiteID int64) ([]*models.TestCase, error) {
	if suiteID <= 0 {
